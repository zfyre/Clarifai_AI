...
class CODEGPT(BaseModel):
    code: str = Field(description="""This field requires a detailed code to be generated by you related to the query asked by the user, Note the code generated should be detailed!""")

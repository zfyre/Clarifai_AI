...
class CODEGPT(BaseModel):
    description: str = Field(description="""This Field Provides a detailed answer about the query of the user format should be: "Latex".""")
    code: str = Field(description="""This field requires a detailed code (at least 100 lines) to be generated by you related to the query asked by the user, Note the code generated should be detailed!""")
    code_description: str = Field(description="""This Field Provides a detailed description about the code generated format should be: "Latex".""")
